...
- Enhance fine-tuning options with validation split and early stopping parameters; update README for clarity

### 🐛 Bug Fixes

- Bump version to 0.1.12 in Cargo.toml and pyproject.toml files
